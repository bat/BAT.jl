...
@testset "distribution_functions" begin
    @testset "_check_rand_compat" begin
        @test BAT._check_rand_compat(MvNormal(I(2)), ones(2,10)) == nothing
    ...
    @testset "BAT.issymmetric_around_origin" begin
        ...
        @test BAT.issymmetric_around_origin(MvNormal(zeros(2), I(2))) == true
        @test BAT.issymmetric_around_origin(MvNormal(ones(2), I(2))) == false
