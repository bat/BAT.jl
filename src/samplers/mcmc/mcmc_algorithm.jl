...
function _create_proposal_state(
    proposal::MCMCProposal, target::BATMeasure, context::BATContext,
    x_init::AbstractVector, z_init::AbstractVector,
    ::Union{Nothing,AbstractVector}, f_transform::Function, rng::AbstractRNG,
)
    return _create_proposal_state(proposal, target, context, x_init, z_init, f_transform, rng)
end
