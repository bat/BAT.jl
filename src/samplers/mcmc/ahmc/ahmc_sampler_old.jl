...
function AHMCold(;
    ...
    AHMCold(metric, gradient, integrator, proposal, adaptor)
end
...
function bat_sample(
    ...
    Threads.@threads for i in 1:n_chains
        algorithm.integrator.step_size == 0.0 ? algorithm.integrator.step_size = AdvancedHMC.find_good_stepsize(hamiltonian, initial_v[i]) : nothing
