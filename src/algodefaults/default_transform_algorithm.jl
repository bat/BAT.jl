...
bat_default(::typeof(bat_transform), ::Val{:algorithm}, ::PriorToUniform, ::BATPushFwdMeasure) = PriorSubstitution()
...
bat_default(::typeof(bat_transform), ::Val{:algorithm}, ::PriorToNormal, ::BATPushFwdMeasure) = PriorSubstitution()
