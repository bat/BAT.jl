...
_h5io_read_postprocess(nt::NamedTuple{(:chainid, :walkerid, :chaincycle, :stepno, :proposalid, :sampletype)}) =
    MCMCSampleIDVector((nt.chainid, nt.walkerid, nt.chaincycle, nt.stepno, nt.proposalid, nt.sampletype))
