...
@with_kw struct Cov2D <: BATMakieRecipe
        weights = nothing
        filter = false
        nsigma = 1.0
        color = :red
...
@with_kw struct Std1D <: BATMakieRecipe
        weights = nothing
        filter = false
        nsigma = 1.0
        color = :red
...
@with_kw struct Std2D <: BATMakieRecipe
        weights = nothing
        filter = false
        nsigma = 1.0
        color = :red
...
@with_kw struct Mean1D <: BATMakieRecipe
        weights = nothing
        filter = false
        color = :black
        linestyle = :dot
...
@with_kw struct Mean2D <: BATMakieRecipe
        weights = nothing
        filter = false
        color = :black
        linestyle = :dot
...
@with_kw struct Errorbars1D <: BATMakieRecipe
        weights = nothing
        filter = false
        nsigma = 1.0
        y = 0.0
...
@with_kw struct Errorbars2D <: BATMakieRecipe
        weights = nothing
        filter = false
        nsigma = 1.0
        color = :red
...
# TODO REFACTOR
@with_kw struct PDF1D <: BATMakieRecipe
