...
@with_kw struct KDE1D <: BATMakieRecipe
        weights = nothing
        filter = false
...
@with_kw struct KDE2D <: BATMakieRecipe
        weights = nothing
        filter = false
        colormap = :Blues
        alpha = 1.0
...
@with_kw struct QuantileKDE1D <: BATMakieRecipe
        weights = nothing
        filter = false
...
@with_kw struct QuantileKDE2D <: BATMakieRecipe
        weights = nothing
        filter = false
