...
#MultimodalStudentT d = 1 = MultimodalCauchy
multi_cauchy2D = (posterior=BAT.MultimodalStudentT(µ=5.,σ=4.,d = 1, n=2),mode=analytical_stats_multi_cauchy2D[1],mean=analytical_stats_multi_cauchy2D[2],var=analytical_stats_multi_cauchy2D[3],chi2=[9999],ks=[9999.,9999.],ahmi=[9999.,9999.])
