...
gauss2D = (posterior=MvNormal([15,10],sig),mode=analytical_stats_gauss2D[1],mean=analytical_stats_gauss2D[2],var=analytical_stats_gauss2D[3],chi2=[9999],ks=[9999.,9999.],ahmi=[9999.])
